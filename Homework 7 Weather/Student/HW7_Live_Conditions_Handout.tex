...
\\\\
We give you a working template with the campuses, URLs, function skeletons, and a \texttt{jq} guide already in place. You fill in the \texttt{TODO} sections. Every API is \textbf{free and needs no account or API key}.

% --- GETTING STARTED ---
\section{Getting Started: The Template}
Open the \texttt{hw7-conditions} folder and fill in the \texttt{TODO} sections.
\begin{itemize}
